...
const navItems = [
  { name: 'Courses', path: '/guru/dashboard', icon: BookOpen },
  { name: 'Students', path: '/guru/students', icon: Users },
    ...
    >
      <div class="p-6 flex items-center justify-between">
        <div class="flex items-center space-x-3 text-emerald-600">
          ...
          <span class="font-bold text-zinc-900 dark:text-white tracking-tight">FACULTY.IO</span>
        </div>
      ...
      <div class="p-4 mt-auto border-t border-zinc-200 dark:border-zinc-800">
        <router-link to="/guru" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-zinc-500 hover:text-red-500 transition-colors w-full text-left">
    ...
    <main class="flex-grow flex flex-col overflow-hidden w-full">
      ...
      <header class="h-20 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 px-4 lg:px-8 flex items-center justify-between">
        <div class="flex items-center">
          ...
          <h2 class="text-lg lg:text-xl font-semibold truncate">Faculty Dashboard</h2>
        </div>
